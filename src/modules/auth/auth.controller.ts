...
import { SwaggerErrorExamples } from '../../shared/utils/swagger-error-response.util';
...
export class AuthController {
  ...
  @Public()
   @Post('register')
  @ApiOperation({ summary: '회원가입', description: '일반 팬 회원가입 API' })
  @ApiBody({ type: RegisterDto })
  @ApiResponse({ status: 201, description: '회원가입 성공' })
  @ApiResponse({ status: 400, description: '이미 존재하는 이메일 또는 닉네임' })
